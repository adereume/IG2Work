...
/**
 * La classe QuestionActivity gère l'activité de visualisation d'une question.
 */
public class QuestionActivity extends RestActivity {
    ...
    /*
    Récupération de la question (côté étudiant)
     */
            ...
            public void traiteReponse(JSONObject o, String action) {
                try {
                    ...
                    if(question.getInt("answerIsVisible") == 1) {
                        ...
                        // L'étudiant ne peut pas répondre lorsque la correction est visible
                    ...
                    if(reponses.length() > 0) {
                        ...
                        if(!reponse.isNull("answer")) {
                            ...
                            // L'étudiant ne peut plus répondre lorsqu'il a déjà répondu
                            MenuItem item = getMenu().findItem(R.id.action_answer);
                            item.setVisible(false);
                        } else {
    ...
    /*
    Récupération de la question (côté enseignant)
     */
        ...
        new RequestActivity() {
            ...
            public void traiteReponse(JSONObject o, String action) {
                try {
                    ...
                    // L'enseignant ne voit pas la zone "Votre réponse"
                    titleAnswer.setVisibility(View.GONE);
                    ...
                    // Zone des répondes des étudiants
                    JSONArray reponses = o.getJSONArray("reponses");
                    if(reponses.length() > 0) {
    ...
    /*
    Change la visibilité de la correction de la question
     */
